...
class Game {
    ...
    draw() {
        ...
        // Paletas
        this.paddle1.draw('green', 100); // Le aumenta 100 a los 100 base del constructor para que sea el doble del tamaño
        this.paddle2.draw('red', 0); // Tamaño 100 por el constructor
    }
    ...
    update() {
        ...
        // Detectar cuando la pelota 1 (azul) sale de los bordes (punto marcado)
        ...
        // Detectar cuando la pelota 2 (naranja) sale de los bordes (punto marcado)
        ...
        // Detectar cuando la pelota 3 (blanca) sale de los bordes (punto marcado)
        ...
        // Detectar cuando la pelota 4 (cyan) sale de los bordes (punto marcado)
        ...
        // Detectar cuando la pelota 5 (gris) sale de los bordes (punto marcado)
